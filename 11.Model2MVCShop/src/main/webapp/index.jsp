	...
	<script type="text/javascript">
		...
		$( function() {
			$("a[href='#' ]:contains('상품검색')").on("click" , function() {
				...
				popwin = window.open("/popWin/join.jsp",
						"popWin", 
						"left=300,top=300,width=500,height=100,marginwidth=0,marginheight=0,"+
...
<body>
	...
	<div class="navbar  navbar-default">
        ...
        <div class="container">
        	...
        	<a class="navbar-brand" href="#">11.Model2MVCShop</a>
			...
			<!--  Menu 구성 end /////////////////////////////////////-->   
	 	 	...
	 	 	<div class="col-md-9">
				<div class="jumbotron">
			  		...
			  		<p>로그인 이전 상품검색만 가능합니다.</p>
			  		<p>회원가입 후 로그인 진행해주세요</p>
