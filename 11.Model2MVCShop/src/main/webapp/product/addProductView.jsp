...
<!-- // form Start ////////////////////////////////////////////////// -->
	<form class="form-horizontal" name=addProductView>
...
<!-- // 제조일자 /////////////////////////////////////////////////////-->
   <div class="form-group">
    <label for="manuDate" class="col-sm-offset-1 col-sm-3 control-label">상품제조일자</label>
			...
			onclick="show_calendar('document.addProductView.manuDate', document.addProductView.manuDate.value)"/>
    <div class="col-sm-4"> <!-- $('form[name="addProductView"]').val(); -->
      <input type="text" class="form-control" id="manuDate" name="manuDate" placeholder="상품제조일자">
    </div>
  </div>
